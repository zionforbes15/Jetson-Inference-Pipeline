...
int main() {
    ...
    std::string enginePath = "/home/zion/model/engine/ch_impurities_v2_240828.engine";
    ...
    // 3. 图像预处理
    cv::Mat img = cv::imread("/home/zion/model/yolo/test2.jpg"); 
    ...
    // 输出结果
    std::cout << "\n分类模型推理成功 [" << outputNodeName << "] 结果如下:" << std::endl;
    std::cout << "-----------------------------------------------" << std::endl;
